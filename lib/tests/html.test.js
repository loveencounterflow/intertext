...
foo:bar foo-bar Foo-bar`.split(/\s+/);
  ...
  this["_HTML.datoms_as_html (4)"] = function(T, done) {
    var datom_as_html, datoms_as_html, dhtml, new_dhtml_writer;
    INTERTEXT = require('../..');
    ({datoms_as_html, datom_as_html, new_dhtml_writer} = INTERTEXT.HTML.export());
    //.........................................................................................................
    ...
    whisper('^7778^', '------------------------------------------');
    dhtml('one', dhtml('between'), function() {
      return dhtml('two', 'here');
    });
    // dhtml 'three' # , ->
