...
foo:bar foo-bar Foo-bar`.split(/\s+/);
  ...
  this["HTML.dhtml"] = async function(T, done) {
    var dhtml, error, i, len, matcher, parse_compact_tagname, probe, probes_and_matchers;
    INTERTEXT = require('../..');
  ...
  this["HTML.datoms_as_html (1)"] = async function(T, done) {
    var datoms_as_html, dhtml, error, i, len, matcher, probe, probes_and_matchers;
    INTERTEXT = require('../..');
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["_HTML.datoms_as_html (4)"] = function(T, done) {
    var datoms_as_html, dhtml, h, new_dhtml_writer, text;
    INTERTEXT = require('../..');
