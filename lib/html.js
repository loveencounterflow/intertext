(function() {
  'use strict';
  var CND, Cupofjoe, DATOM, HtmlParser, alert, assign, badge, debug, echo, excluded_content_parts, freeze, help, info, is_frozen, isa, jr, lets, log, new_datom, rpr, select, thaw, type_of, types, urge, validate, warn, whisper,
    indexOf = [].indexOf;
  ...
  this.$html_from_datoms = function() {
    ...
    return $((d, send) => {
      var i, len, ref, x;
      if (!isa.list(d)) {
        return send(this._datom_as_html(d));
      }
