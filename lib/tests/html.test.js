...
foo:bar foo-bar Foo-bar`.split(/\s+/);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["_HTML dhtml writer"] = function(T, done) {
    var INTERTEXT, datoms_as_html, dhtml, h, new_dhtml_writer, text;
    INTERTEXT = require('../..');
    ({datoms_as_html, dhtml, text, datoms_as_html, new_dhtml_writer} = INTERTEXT.HTML.export());
    //.........................................................................................................
    ...
    probes_and_matchers = [
      ...
      [
        ...
        [
          ...
          "<link href=path/to/styles.css rel=stylesheet></link>"
        ],
        null
      ],
      [
...
<h1><strong>CHAPTER VI.</strong> <name ref=hd553>Humpty Dumpty</h1>`;
  ...
  if (module === require.main) {
    (() => { // await do =>
      ...
      test(this["HTML.html_as_datoms (2)"]);
      // @[ "HTML dhtml writer" ]()
      // test @[ "HTML specials" ]
      // @[ "_HTML demo (layout)" ]()
      // @[ "《现代常用独体字规范》" ]()
