(function() {
  ...
  */
  ...
  // TESTS
  //-----------------------------------------------------------------------------------------------------------
  this["MKTS.html_as_datoms"] = async function(T, done) {
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve, reject) {
          var text;
          text = probe;
          return resolve(MKTS.html_as_datoms(text));
        });
      });
    }
    //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["MKTS.html_as_datoms (compact syntax)"] = async function(T, done) {
    var error, i, len, matcher, probe, probes_and_matchers;
    probes_and_matchers = [
      [
        // [ '<columns =2 =3>' ]
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve, reject) {
          return resolve(MKTS.html_as_datoms(probe));
        });
      });
    }
    //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["MKTS.$html_as_datoms"] = function(T, done) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["MKTS.html_as_datoms (dubious)"] = async function(T, done) {
    var error, i, len, matcher, probe, probes_and_matchers;
    probes_and_matchers = [
      [
...
`;
    ref = datoms = MKTS.html_as_datoms(text);
    ...
    echo(result = ((function() {
      ...
      for (j = 0, len1 = datoms.length; j < len1; j++) {
        d = datoms[j];
        results.push(MKTS.datom_as_html(d));
      }
      return results;
    })()).join(''));
...
<h1#c4443><strong.myclass>CHAPTER VI.</strong> <name ref=hd553>Humpty Dumpty</h1>`;
    ...
    ref = datoms = MKTS.html_as_datoms(buffer);
    // debug '^80009^', buffer
