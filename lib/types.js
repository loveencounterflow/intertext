(function() {
  ...
  this.declare('intertext_slabs_slabjoints', {
    tests: {
      ...
      "x.version is a nonempty_text": function(x) {
        return this.isa.nonempty_text(x.version);
      },
      "x.joints is an object": function(x) {
        return this.isa.object(x.joints);
      },
      "x.joints.blunt is a chr": function(x) {
        return this.isa.chr(x.joints.blunt);
      },
      "x.joints.shy is a chr": function(x) {
        return this.isa.chr(x.joints.shy);
      },
      "x.joints.space is a chr": function(x) {
        return this.isa.chr(x.joints.space);
      },
      "x.cursor is a count": function(x) {
        return this.isa.count(x.cursor);
      }
    }
  });
