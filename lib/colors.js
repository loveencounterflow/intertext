...
// debug @ansi24bit_code_from_name 'Azure'
  ...
  if (module === require.main) {
    (() => {
      var BAR, C, H, L, _, border, color, color_1, color_2, delta_C, delta_H, delta_L, demo_lch_gamut, green_lch, i, j, k, n, puffer, red_lch, ref, reset, scale, step_count, text;
      // @demo_1()
      // @demo_truecolor()
...
// for L in [ 0 .. 100 ] by +10
      ...
      [L, C, H] = green_lch;
      scale = '';
      for (_ = j = 1, ref = step_count; (1 <= ref ? j <= ref : j >= ref); _ = 1 <= ref ? ++j : --j) {
