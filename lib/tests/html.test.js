...
foo:bar foo-bar Foo-bar`.split(/\s+/);
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_html (singular tags)"] = async function(T, done) {
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve, reject) {
          var d;
          d = new_datom(...probe);
          return resolve(HTML.datoms_as_html(d));
        });
      });
    }
    //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_html (closing tags)"] = async function(T, done) {
    var DATOM, HTML, INTERTEXT, error, i, len, lets, matcher, new_datom, probe, probes_and_matchers, select;
    DATOM = new (require('datom')).Datom({
      dirty: false
    });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_html (opening tags)"] = async function(T, done) {
    var DATOM, HTML, INTERTEXT, error, i, len, lets, matcher, new_datom, probe, probes_and_matchers, select;
    DATOM = new (require('datom')).Datom({
      dirty: false
    });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_html (texts)"] = async function(T, done) {
    var DATOM, HTML, INTERTEXT, error, i, len, lets, matcher, new_datom, probe, probes_and_matchers, select;
    DATOM = new (require('datom')).Datom({
      dirty: false
    });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_html (opening tags w/ $value)"] = async function(T, done) {
    var DATOM, HTML, INTERTEXT, error, i, len, lets, matcher, new_datom, probe, probes_and_matchers, select;
    DATOM = new (require('datom')).Datom({
      dirty: false
    });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_html (system tags)"] = async function(T, done) {
    var DATOM, HTML, INTERTEXT, error, i, len, lets, matcher, new_datom, probe, probes_and_matchers, select;
    DATOM = new (require('datom')).Datom({
      dirty: false
    });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_html (raw pseudo-tag)"] = async function(T, done) {
    var DATOM, HTML, INTERTEXT, error, i, len, lets, matcher, new_datom, probe, probes_and_matchers, select;
    DATOM = new (require('datom')).Datom({
      dirty: false
    });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_html (doctype)"] = async function(T, done) {
    var DATOM, HTML, INTERTEXT, error, i, len, lets, matcher, new_datom, probe, probes_and_matchers, select;
    DATOM = new (require('datom')).Datom({
      dirty: false
    });
        ...
        return new Promise(function(resolve, reject) {
          ...
          return resolve(((function() {
            ...
            for (j = 0, len1 = ref.length; j < len1; j++) {
              d = ref[j];
              results.push(HTML.datoms_as_html(d));
            }
            return results;
          })()).join('|'));
        });
  ...
  this["HTML.parse_compact_tagname"] = async function(T, done) {
    var INTERTEXT, error, h, i, len, matcher, parse_compact_tagname, probe, probes_and_matchers;
    INTERTEXT = require('../..');
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.dhtml"] = async function(T, done) {
    var INTERTEXT, dhtml, error, i, len, matcher, parse_compact_tagname, probe, probes_and_matchers;
    INTERTEXT = require('../..');
    ({parse_compact_tagname, dhtml} = INTERTEXT.HTML.export());
    //.........................................................................................................
    probes_and_matchers = [
      [
        ["div"],
  ...
  this["HTML.datoms_as_html (1)"] = async function(T, done) {
    var INTERTEXT, datoms_as_html, dhtml, error, i, len, matcher, probe, probes_and_matchers;
    INTERTEXT = require('../..');
    ({datoms_as_html, dhtml} = INTERTEXT.HTML.export());
    //.........................................................................................................
    probes_and_matchers = [
      [["div"],
      "<div></div>",
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve, reject) {
          ...
          return resolve(datoms_as_html(dhtml(...probe)));
        });
      });
    }
    //.........................................................................................................
  ...
  this["HTML.datoms_as_html (2)"] = function(T, done) {
    var INTERTEXT, datoms_as_html, dhtml, ds;
    INTERTEXT = require('../..');
    ({datoms_as_html, dhtml} = INTERTEXT.HTML.export());
    //.........................................................................................................
    urge(ds = dhtml('article#c2', {
      editable: true
  ...
  this["HTML.datoms_as_html (3)"] = function(T, done) {
    ...
    urge(ds = dhtml('article#c2', {
      editable: true
    }, dhtml('h1', "A truly curious Coincidence"), dhtml('p.noindent', dhtml('em', "Seriously,"), " he said, ", dhtml('em', "we'd better start cooking now."))));
    //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["HTML.datoms_as_nlhtml (1)"] = function(T, done) {
    var INTERTEXT, datoms_as_nlhtml, ds, html_as_datoms;
    INTERTEXT = require('../..');
    ({datoms_as_nlhtml, html_as_datoms} = INTERTEXT.HTML.export());
    //.........................................................................................................
    urge(jr(ds = html_as_datoms(`<h1>A Star is Born</h1><p class=noindent>Stars are born when hydrogen amasses.</p><p>When they are <em>big</em> enough, nuclear fusion starts.</p>`)));
    //.........................................................................................................
...
<h1><strong>CHAPTER VI.</strong> <name ref=hd553>Humpty Dumpty</h1>`;
  ...
  this["_HTML demo (layout)"] = function(T, done) {
    var DATOM, css, datoms_as_html, dhtml, layout, lets, new_datom, raw, script, select, text;
    DATOM = new (require('datom')).Datom({
      dirty: false
    });
    ({new_datom, lets, select} = DATOM.export());
    ({dhtml, datoms_as_html, raw, text, script, css} = (require('../..')).HTML.export());
  ...
  this["《现代常用独体字规范》"] = function(T, done) {
    var $, $async, $drain, $html_as_datoms, $remove_empty_tags, $remove_styles_and_classes, $resolve_entities, $show, $skip_styles, $split, $trim, $watch, DATOM, SP, css, datoms_as_html, dhtml, html_as_datoms, html_source, lets, new_datom, pipeline, raw, script, select, text;
    SP = require('steampipes');
    // SP                        = require '../../apps/steampipes'
    ...
    ({new_datom, lets, select} = DATOM.export());
    ({dhtml, html_as_datoms, $html_as_datoms, datoms_as_html, raw, text, script, css} = (require('../..')).HTML.export());
  ...
  if (module === require.main) {
    (() => { // await do =>
      // await @_demo()
      // test @
      test(this["HTML.datoms_as_nlhtml (1)"]);
