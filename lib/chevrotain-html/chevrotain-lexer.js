(function() {
  ...
  * quotes (`'` and `"`).
   */
  var CHVRTN_create_token, CND, Lexer, alert, assign, badge, debug, echo, freeze, help, i_close, i_name, i_open, i_slash, i_slash_close, i_slash_open, i_special_close, i_whitespace, info, jr, log, o_cdata, o_comment, o_doctype, o_pi, o_text, o_xmldecl, rpr, stm_slash1, stm_slash2, stm_text, tok, tokensDictionary, urge, v_equals, v_value, warn, whisper, xmlLexerDefinition;
  ...
  ({
    createToken: CHVRTN_create_token,
    Lexer
  } = require('chevrotain'));
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.tokensDictionary = tokensDictionary = {};

  //-----------------------------------------------------------------------------------------------------------
  tok = function(name, pattern, settings) {
    var newTokenType, switch_mode;
  ...
  i_special_close = tok('i_special_close', /\?>/, {
    pop_mode: true
  });

  i_slash_close = tok('i_slash_close', /\/>/, {
    pop_mode: true
  });

  stm_slash1 = tok('stm_slash1', /\/(?!>)/, {
    push_mode: 'slashtext_mode'
  });

  stm_slash2 = tok('stm_slash2', /\//, {
  ...
  v_equals = tok('v_equals', /\s*=\s*/, {
    push_mode: 'value_mode'
  });

  v_value = tok('v_value', /"[^"]*"|'[^']*'|[^>\s\/]+/, {
    pop_mode: true
  });
  ...
  xmlLexerDefinition = {
    ...
    modes: {
      //.......................................................................................................
      outside_mode: [o_comment, o_cdata, o_doctype, o_xmldecl, o_pi, i_slash_open, i_open, o_text],
      //.......................................................................................................
      inside_mode: [i_close, i_special_close, i_slash_close, stm_slash1, i_slash, v_equals, i_name, i_whitespace],
      //.......................................................................................................
      slashtext_mode: [stm_slash2, stm_text],
      //.......................................................................................................
      value_mode: [v_value]
    }
  };
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.tokenize = function(source, lexer_mode = null) {
    return this.lexer.tokenize(source, lexer_mode);
  };
