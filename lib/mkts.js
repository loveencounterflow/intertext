(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.datom_as_html = (...P) => {
    return (HTML != null ? HTML : HTML = (require('..')).HTML).datom_as_html(...P);
  };
...
*/
    for (idx = i = 0, len = datoms.length; i < len; idx = ++i) {
      ...
      for (j = 0, len1 = ref.length; j < len1; j++) {
        ...
        if (attribute[0] === '#') {
          ...
          (update.class != null ? update.class : update.class = []).push(avalue);
        }
      }
      if (update.class != null) {
        // debug '^3388^', attributes
        update.class = update.class.join(' ');
      }
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.html_as_datoms = function(text) {
    ...
    while (true) {
      ...
      tags = this._analyze_mkts_compact_syntax(HTML.html_as_datoms(text.slice(idx_0, +idx_1 + 1 || 9e9)));
      if (text[idx_1 - 1] === '/') {
