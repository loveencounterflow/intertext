(function() {
  ...
  this._extract_tokens = function*(source, tree, level = 0) {
    var atr, atrs, i, indent, j, k, key, len, len1, name, ref, ref1, ref2, ref3, ref4, ref5, start, start1, stop, stop1, text, text0, text1, text2, token, token_name, tokens, type, v;
    if (tree == null) {
