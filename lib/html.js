(function() {
  'use strict';
  var CND, CUPOFHTML, Cupofjoe, DATOM, HtmlParser, MAIN, alert, assign, badge, debug, echo, excluded_content_parts, freeze, help, info, is_frozen, isa, jr, lets, log, new_datom, rpr, select, thaw, type_of, types, urge, validate, warn, whisper,
    indexOf = [].indexOf;
  ...
  CUPOFHTML = { // @
    ...
    //---------------------------------------------------------------------------------------------------------
    text: function(text) {
      return this.cram(MAIN.text(text));
    }
  };
